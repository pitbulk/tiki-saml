...
"New articles submited" => "S'han enviat noves col·laboracions d'articles",
"created the article" => "ha creaat l'article",
"New blog posts" => "Noves publicacions de blocs",
...
"%0 <a href=%1>replied</a> to the topic %2" => "%0 <a href=%1>ha respost</a> al tema %2",
...
"Blog title (asc)" => "Títol del bloc (asc)",
...
"Password must be different from the user login" => "La contrasenya ha de ser diferent del nom d'usuari",
...
"Content is parsed like wiki page" => "El contingut és interpretat com una pàgina Wiki",
...
"The entire Tiki Community would like to thank you and help you get introduced to Tiki" => "La Comunitat de Tiki en conjunt voldria donar-te les gràcies i ajudar-te amb la teva introducció a Tiki",
"How To Get Started" => "Com __posar-te en marxa__ ",
"Tiki has more than 1000 features and settings" => "Tiki té més de 1000 funcionalitats i ajustaments",
"This allows you to create both very simple and complex websites" => "Això li permet crear llocs web des de molt simples fins a molt complexos",
"We understand that so many features might seem overwhelming at first. This is why we offer you two different ways to __Get Started__ with Tiki" => "Entenem que un programari amb tantes característiques pot semblar aclaparador al principi. Aquesta és la raó per la que t'oferim dues maneres diferents per a __Posar-te en marxa__ amb Tiki",
"Manual Setup using Admin Panel" => "Configuració Manual emprant el Panell d'Administració",
"Get Started using Admin Panel" => "Posa't en marxa emprant el Panell d'Administració",
"Who Should Use This" => "Qui hauria d'emprar això",
"You are familiar with software Admin Panels" => "Estàs familiaritzat amb panells d'administració de programes",
"You enjoy exploring and playing with many options" => "T'agrada explorar i jugar amb moltes opcions",
"You already know Tiki" => "Ja coneixes Tiki",
"Easy Setup using Profiles" => "Ajust fàcil emprant Perfils (de Configuració)",
"Get Started using Profiles" => "Posa't en marxa emprant Perfils (de Configuració)",
"You want to get started quickly" => "Vols començar ràpidament",
"Featured Profiles" => "Perfils destacats",
"__Collaborative Community__ ([%0|apply profile now])" => "__Comunitat Col·laborativa__ ([%0|instal·la el perfil ara])",
"Setup to help subject experts and enthusiasts work together to build a Knowledge Base" => "Configuració per ajudar a entusiastes i experts en les vostres matèries a treballar conjuntament per construir una Base de Coneixement",
"Wiki Editing" => "Edició Wiki",
"Personal Member Spaces" => "Espais personals per als membres",
"__Personal Blog and Profile__ ([%0|apply profile now])" => "__Bloc i perfil personal__ ([%0|instal·la el perfil ara])",
"Setup with many cool features to help you integrate the Social Web and establish a strong presence in the Blogosphere" => "Configuració amb moltes funcionalitats guais per ajudar-te a ser part de la Web Social i establir-te una presència notable a la Blogosfera",
"Blog (Full set of blog related features)" => "Bloc (Conjunt complert de característiques relacionades amb bitàcoles - blogs)",
"RSS Integration" => "Integració RSS",
"Video Log" => "Registre de vídeos",
"__Company Intranet__ ([%0|apply profile now])" => "__Intranet d'Empresa__ ([%0|instal·la el perfil ara])",
"Setup for a Corporate Intranet of a typical medium-sized business" => "Configuració per a una intranet d'Empresa d'un negoci típic de mida mitjana (PIME)",
"Company News Articles" => "Articles de Notícies de l'Empresa",
"Executive Blog" => "Bloc Executiu",
"File Repository & Management" => "Gestió d'arxius i repositoris",
"Collaborative Wiki" => "Wiki col·laboratiu",
"__Small Organization Web Presence__ ([%0|apply profile now])" => "__Presència Web d'una Organització Petita__ ([%0|instal·la el perfil ara])",
"Setup for a Web Presence of a typical small business or non-profit" => "Configuració per a la presència web d'una entitat sense ànim de lucre, ONG o petita empresa típica",
"Company News & Updates" => "Notícies de l'entitat i actualitzacions",
"File Gallery (great for Media Kit)" => "Galeria d'arxius (ideal per a un kit per als mitjans de comunicació)",
"Contact Form" => "Formulari de Contacte",
"Congratulations" => "Felicitats",
"This is the default homepage for your Tiki. If you are seeing this page, your installation was successful" => "Aquesta és la pàgina Inicial per omissió per al teu Tiki. Si veus aquesta pàgina, la teva instal·lació s'ha realitzat correctament",
"You can change this page after logging in. Please review the [http://doc.tiki.org/wiki+syntax|wiki syntax] for editing details" => "Pots canviar aquesta pàgina després de connectar-te. Si us plau, revisa la [http://doc.tiki.org/wiki+syntax|sintaxi wiki] per als detalls d'edició",
"{img src=img/icons/star.png alt=\\\"Star\\\"} Get started" => "{img src=img/icons/star.png alt=\\\"Star\\\"} Posa't en marxa",
"To begin configuring your site" => "Per a començar la configuració del teu lloc",
"1) Log in with your newly created password" => "1) Inicia la sessió com a usuari __admin__ amb la teva nova contrasenya",
"2) Manually Enable specific Tiki features" => "2) Habilita funcionalitats específiques de Tiki",
"3) Run Tiki Profiles to quickly get up and running" => "3) Aplica perfils de configuració de Tiki per posar-te en marxa de forma àgil",
"{img src=img/icons/help.png alt=\\\"Help\\\"} Need help" => "{img src=img/icons/help.png alt=\\\"Help\\\"} Necessites ajuda",
"For more information" => "Per a més informació",
"[http://info.tiki.org/Learn+More|Learn more about Tiki]" => "[http://info.tiki.org/Learn+More|Més informació sobre Tiki]",
"[http://info.tiki.org/Help+Others|Get help], including the [http://doc.tiki.org|official documentation] and [http://tiki.org/forums|support forums]" => "[http://info.tiki.org/Help+Others|Obtenir ajuda], inclosos la [http://doc.tiki.org|documentació oficial] i els [http://www.tiki.org/forums|fòrums de suport]",
"[http://info.tiki.org/Join+the+community|Join the Tiki community]" => "[http://info.tiki.org/Join+the+community|Uneix-te a la comunitat de Tiki]",
"You don't feel like learning the Admin Panel right away" => "No tens ganes d'aprendre el Panell d'Administració immediatament",
"You want to quickly test out some of Tiki's Features" => "Vols provar de forma ràpida algunes funcionalitats de Tiki",
"Highlight Company's Products and Services" => "Destacar els Productes i Serveis de la Companyia",
"new" => "nou",
"Saved" => "Desat",
...
"This field is required" => "Es obligatori omplir aquest camp del formulari",
"Please enter a valid %s.  No spaces, more than %d characters and contain %s" => "Si us plau, introdueix al camp %s un valor vàlid. Sense espais, més de %d caràcters i que contingui %s",
"username" => "usuari",
...
"Non-parsed (Wiki syntax does not apply)" => "Sense interpretar (No s'aplicarà la sintaxi wiki)",
...
"Requires BBB >= 0.8" => "Requereix BBB >= 0.8",
"Off" => "Inactiu",
"On" => "Actiu",
...
"Invalid email" => "Correu-e Invàlid",
"Passwords do not match" => "No coincideixen les dues contrasenyes",
"Insert one item per line" => "Insereix un ítem per línia",
"Fields marked with a * are mandatory." => "Els camps marcats amb un asterisc (*) són obligatoris.",
"Item Count" => "Recompte d'ítems",
"Filters" => "Filtres",
...
"new blog posts" => "noves entrades al bloc",
...
"To add/remove blogs, go to \"Create/Edit Blog\" under \"Blogs\" on the application menu, or" => "Per afegir/eliminar bitàcoles, ves a \"Crea/Edita bloc\" dins de \"Blocs\" en el menú principal de l'aplicació, o",
"Click Here" => "Cliqueu aquí",
"Comments" => "Comentaris",
...
"You will receive an email with the information needed to log into this site the first time" => "Rebràs un correu-e amb la informació necessària per a connectar-te per primer cop a aquest lloc web",
...
"Expiration Date" => "Data de caducitat",
"article post at" => "article publicat a",
"New blog post: {\$mail_title}, \"{\$mail_post_title}\", by {\$mail_user|username} at {\$mail_date|tiki_short_datetime:\"\":\"n\"}" => "Nova publicació al bloc: {\$mail_title}, \"{\$mail_post_title}\", per {\$mail_user|username} el {\$mail_date|tiki_short_datetime:\"\":\"n\"}",
"View the blog at:" => "Visualitza el bloc a:",
"New blog post at %s" => "Nova publicació al bloc %s",
...
"Old:" => "Antic:",
"updated" => "Actualitzat",
"The Wiki page {\$mail_objectname} was commented on by" => "La pàgina Wiki {\$mail_objectname} ha estat comentada per",
"an anonymous user" => "un usuari anònim",
"The article {\$mail_objectname} was commented on by" => "L'article {\$mail_objectname} ha estat comentat per ",
"The tracker item {\$mail_item_title} of tracker {\$mail_objectname} was commented on by" => "L'ítem {\$mail_item_title} del formulari-bd {\$mail_objectname} ha estat comentat per",
"You can view the comment by following this link" => "Pots veure el comentari en seguir aquest enllaç",
...
"The page {\$mail_page} was changed by {\$mail_user|username} at {\$mail_date|tiki_short_datetime:\"\":\"n\"}" => "La pàgina {\$mail_page} ha estat canviada per {\$mail_user|username} el {\$mail_date|tiki_short_datetime:\"\":\"n\"}",
...
"Minimum %0 characters long" => "Com a mínim %0 caràcters de longitud",
"[-]" => "[-]",
"vote" => "vota",
"Requires" => "Requireix",
"Rate" => "Qualificació",
...
"Add new child page" => "Afegeix una nova pàgina filla",
...
"Edit This Tracker" => "Edita aquest Formulari-bd",
"Edit Fields" => "Edita els camps",
"Create Item" => "Crea un ítem",
"View Items" => "Visualitza els ítems",
...
"Users Information Tracker Fields Asked at Registration Time<br />(fieldIds separated with :)" => "Camps del Formulari-bd d'Informació d'Usuaris que es demanaran en el moment de Registre<br />(IdsDeCamps separats amb :)",
...
"Newer content available" => "Hi ha contingut més nou disponible",
...
"Reset view to default" => "Torna a especificar la visualització al que hi ha per omissió",
"Save current view as default" => "Guarda la visualització actual com a la visualització per defecte",
"Center map to saved point" => "Centra el mapa al punt desat",
"Reset view to site default" => "Torna a especificar la visualització al que hi ha per omissió en aquest lloc",
...
"Select The calendar to export" => "Escull el calendari que vols exportar",
"Calendar Import" => "Importació de Calendaris",
...
"Enter the name of the database that Tiki will use (if already created) or create (if permitted)" => "Introdueix el nom de la base de dades que Tiki emprarà (si ja existeix) o crearà (si té permisos)",
...
"Character Set Conversion" => "Conversió del Conjunt de Caracters",
...
"This will destroy your current database &quot;%0&quot;" => "Això destruirà la teva base de dades actual &quot;%0&quot;",
"Reinstall the database" => "Reinstal·la la base de dades",
"Select database engine" => "Selecciona el motor de la base de dades",
...
"To do so enter the name of the main admin account in the field below" => "Per a fer-ho introdueix el nom del compte d'usuari principal d'administració en el camp de sota",
"Administrator account (optional): <input type=\"text\" name=\"admin_account\"/> <em>The default account is <strong>admin</strong></em>" => "Compte de l'Administrador (opcional): <input type=\"text\" name=\"admin_account\"/> <em>El compte per omissió és <strong>admin</strong></em>",
...
"Stay up-to-date" => "Estigues actualitzat",
"Subscribe to the <a href=\"http://tiki.org/Newsletter\" title=\"Subscribe\" target=\"_blank\">Tiki newsletter</a> or <a href=\"http://info.tiki.org/tiki-articles_rss.php\" title=\"RSS\" target=\"_blank\">RSS feed</a> to learn about new releases, security updates, and community news" => "Subscriu-te al <a href=\"http://tiki.org/Newsletter\" title=\"Subscribe\" target=\"_blank\">Butlletí de Tiki</a> o a l'<a href=\"http://info.tiki.org/tiki-articles_rss.php\" title=\"RSS\" target=\"_blank\">alimentació RSS</a> per a assabentar-te de noves versions que s'alliberin, actualitzacions de seguretat, i notícies de la Comunitat",
...
"Create a drawing" => "Crea un dibuix",
"SlideShow" => "Passi de diapositives",
...
"Duplicate Remote Tracker" => "Duplica el Formulari-bd remot",
"Search for trackers to clone" => "Cerca formularis-bd a clonar",
"Import From Export" => "Importa d'una Exportació prèvia",
"Raw data" => "Dades crues",
"Preserve tracker ID" => "Preserva l'ID del formulari-bd",
"users registered" => "usuaris enregistrats",
"like" => "com",
"Distance (km)" => "Distància (km)",
"List Wiki Pages" => "Llista les Pàgines Wiki",
"Page aliases found" => "S'han trobat noms alias de la pàgina",
...
"Links to this page in other pages" => "Enllaços a aquesta pàgina en altres pàgines",
"Backl." => "Retroenll.",
...
"Wiki Parse Values" => "Interpreta els valors i sintaxi Wiki",
"Parent Spreadsheet" => "Full de càlcul Pare",
...
"Average posts per weblog" => "Mitjana enviaments per bloc web",
"Total size of blog posts" => "Mida total de les publicacions al bloc",
...
" Syntax tips" => " Pistes de sintaxi",
"Link to file from a Wiki page" => "Enllaç a l'arxiu des d'una pàgina Wiki",
"In addition, for image files" => "Addicionalment, per a arxius d'imatge",
"To display full size in a Wiki page" => "Per a mostrar-ho a mida completa en pàgines Wiki",
...
"Are you sure you want to delete this item" => "Segur que vols eliminar aquest ítem",
"Delete item" => "Elimina l'ítem",
"Description is wiki-parsed" => "La descripció es interpretada com a sintaxi wiki",
...
"(automatically generated after item creation)" => "(creat automàticament després de la creació de l'ítem)",
...
"Add Tag" => "Afegeix Marca",
"Subtract" => "Elimina-ho",
"Meeting ID" => "ID de la Trobada",
"Current attendees" => "Assitents actuals",
"No attendees at this time" => "Sense assistents aquesta vegada",
"Last time we checked, the room you requested did not exist" => "El darrer cop que ho vam intentar, no s'havia creat encara la sala que s'ha demanat",
"Current recordings" => "Gravacions actuals",
"On %0 from %1 to %2" => "El %0 des de la/les %1 a la/les %2",
"list" => "llista",
"Zoom" => "Zoom",
"saving.." => "desant..",
...
"allow_url_fopen may potentially be used to upload remote data or scripts. If you dont use the blog feature, you can switch it off." => "el paràmetre allow_url_fopen podria ser emprat per carregar dades remotes o arxius de seqüències d'instruccions. Si no utilitzes la funcionalitat bloc, la pots desactivar.",
...
"You do not have permission to edit this blog" => "Permís denegat per editar aquest bloc",
...
"You do not have permission to remove this blog" => "Permís denegat per traslladar aquest bloc",
...
"No blog indicated" => "No s'indica cap bloc",
